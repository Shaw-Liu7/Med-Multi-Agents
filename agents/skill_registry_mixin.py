    ...
    def register_all_skills(self):
        ...
        for skill_info in discovered:
            ...
            if function_name == "search_history":
                # Scope is bound by AgentLoop from RequestContext. Never invite
                # the model to choose a tenant/user/session identifier.
                parameters = [parameter for parameter in parameters if parameter.name != "session_id"]
